...
export const marketplaceServices: MarketplaceService[] = [
  {
    ...
    tagline: 'Independent QA & security checker that guarantees code works with zero fakes',
    description: 'Independent AI auditor that checks Pull Requests for bypassed assertions, unauthorized functions, and unverified mock code before delivery.',
    monthlyPrice: 499,
    annualPrice: 399,
    priceMonthly: 499,
    ...
    features: [
      'Strict cryptographic host-function syntax inspection',
...
print(f"Audit Status: {result.status} | Passed: {result.victory_audit_passed}")`,
  },
  {
    ...
    description: 'Continuous diagnostic worker that intercepts failing GitHub Actions, analyzes compiler stack traces, and pushes automated fixes in minutes.',
    monthlyPrice: 399,
    annualPrice: 299,
    priceMonthly: 399,
...
print(f"Patched: {job.commit_hash}")`,
  },
  {
    ...
    tagline: 'Real-time pre-execution simulation & private relay routing across EVM',
    description: 'Autonomous protocol maintenance worker that scans yield vaults and price oracles with Flashbots private routing to eliminate wasted fees.',
    monthlyPrice: 799,
    annualPrice: 649,
    priceMonthly: 799,
    ...
    features: [
      'Real-time simulation and net gas yield calculations',
      'Flashbots and private RPC transaction broadcasting',
      'Continuous nonce tracker and dynamic gas fee adjustment',
...
status = client.keepers.simulate(
  ...
  },
  {
    ...
    features: [
      ...
      'Draft PR save-states and real-time GitHub sync',
...
job = client.hunter.solve(issue_url="https://github.com/org/repo/issues/142")`,
  },
  {
    ...
    tagline: 'Deep requirement analyzer extracting strict compliance checklists from RFCs and rules',
    description: 'Deep requirement analyzer that ingests external hackathon rules, RFCs, and governance forums to extract strict compliance checklists.',
    monthlyPrice: 299,
    annualPrice: 249,
    priceMonthly: 299,
...
spec = client.spec_miner.mine(document_url="https://devpost.com/hackathons/example/rules")`,
  },
  {
    ...
    tagline: 'High-speed cloud engine catching GitHub events and dispatching AI workers',
    description: 'FastAPI micro-service deployed on Google Cloud Run to catch GitHub webhooks, verify signatures, and trigger real-time worker dispatches.',
    monthlyPrice: 199,
    annualPrice: 149,
    priceMonthly: 199,
    ...
    features: [
      ...
      'Native real-time event-driven dispatch',
...
export const marketplacePlans: PricingPlan[] = [
  {
    id: 'startup',
    name: 'Startup Swarm',
    target: 'Early-stage startups & fast-moving engineering teams',
    priceMonthly: 299,
    priceAnnualMonthly: 239,
    description: 'Replace routine maintenance costs. Includes 20 verified PRs, automated CI self-healing, and standard Victory Audit.',
    features: [
  ...
  },
  {
    ...
    description: 'High-velocity autonomous delivery for Web3 protocols. 150 PR credits, MEV keeper execution, and strict Victory Audits.',
    popular: true,
    features: [
  ...
  },
  {
    ...
    description: 'Full AI engineering workforce. Unlimited PR credits, dedicated isolated sandboxes, 24/7 SLA, and zero data retention.',
    features: [
